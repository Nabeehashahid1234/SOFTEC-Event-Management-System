import { a4 as commonjsGlobal, R as getDefaultExportFromCjs, r as reactExports, V as React, W as jsxRuntimeExports } from "./server-DF9qAbDw.js";
import { u as useAuth, L as Link } from "./router-BDNVtE_0.js";
import { R as REGISTRATIONS, U as USERS, E as EVENTS, v as venueById, e as eventById, L as LEADERBOARDS, a as ROOM_TYPES } from "./mock-Ca7l8cmZ.js";
import { E as Eyebrow, S as StatCard, P as Pill, H as Hairline, C as CapacityBar } from "./ui-bits-JagVtLz-.js";
import { a as fmtPKR, f as fmtDate, b as countdown } from "./format-CIANsOqg.js";
...
function Dashboard() {
  ...
  if (!user) return null;
  if (user.role === "admin") return /* @__PURE__ */ jsxRuntimeExports.jsx(AdminDash, {});
  if (user.role === "organizer") return /* @__PURE__ */ jsxRuntimeExports.jsx(OrganizerDash, {});
  if (user.role === "judge") return /* @__PURE__ */ jsxRuntimeExports.jsx(JudgeDash, {});
  if (user.role === "sponsor") return /* @__PURE__ */ jsxRuntimeExports.jsx(SponsorDash, { name: user.company ?? user.name, tier: user.tier ?? "Silver" });
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ParticipantDash, { userId: user.id, name: user.name, roll: user.rollNumber });
}
const Page = ({
  children
}) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[1280px] mx-auto px-6 lg:px-10 py-8", children });
function AdminDash() {
  const totalRev = REGISTRATIONS.reduce((s2, r2) => s2 + r2.amount, 0) + 45e5;
  const roleData = [{
    name: "Participant",
    ...
    name: "Sponsor",
    value: USERS.filter((u) => u.role === "sponsor").length
  }];
  const catData = ["Tech", "Business", "Gaming", "General"].map((c2) => ({
    name: c2,
    count: EVENTS.filter((e) => e.category === c2).length
  }));
  const venueData = [...new Set(EVENTS.map((e) => e.venueId))].map((vid) => ({
    name: venueById(vid)?.name ?? "—",
    events: EVENTS.filter((e) => e.venueId === vid).length
  }));
  const revComp = [{
    name: "Registration",
    value: REGISTRATIONS.reduce((s2, r2) => s2 + r2.amount, 0)
  }, {
    name: "Accommodation",
    value: 35e4
  }, {
  ...
  const spark = [10, 14, 12, 18, 22, 28, 34, 38, 46, 52, 60, 72];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Page, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Eyebrow, { children: (/* @__PURE__ */ new Date()).toLocaleDateString("en-GB", {
        weekday: "long",
        day: "2-digit",
        month: "long"
      }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-5xl font-semibold mt-3", children: [
        "Operations ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("em", { className: "italic", children: "Almanac" }),
        "."
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Total Members", value: USERS.length.toString().padStart(3, "0"), hint: "↑ 12 this week" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Programmes", value: EVENTS.length.toString().padStart(2, "0"), hint: "04 categories", accent: "ember" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Gross Revenue", value: fmtPKR(totalRev).replace("PKR ", "₨"), hint: "↑ 18% vs '25", accent: "sage" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Active Patrons", value: USERS.filter((u) => u.role === "sponsor").length.toString().padStart(2, "0"), hint: "01 Title · 02 Gold · 01 Silver", accent: "gold" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-3 gap-5 mb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "Revenue Composition", className: "lg:col-span-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 gap-6 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Pie, { data: revComp, dataKey: "value", innerRadius: 55, outerRadius: 90, paddingAngle: 3, stroke: "none", children: revComp.map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: colors[i] }, i)) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: revComp.map((r2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-2.5 w-2.5 rounded-sm", style: {
            background: colors[i]
          } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 text-sm", children: r2.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-sm tabular text-muted-foreground", children: fmtPKR(r2.value) })
        ] }, r2.name)) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "Member Demographics", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Pie, { data: roleData, dataKey: "value", outerRadius: 85, stroke: "var(--card)", strokeWidth: 2, children: roleData.map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: colors[i] }, i)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { contentStyle: {
          background: "var(--card)",
          border: "1px solid var(--border)",
          borderRadius: 6,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-5 mb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "Programme Distribution", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: catData, layout: "vertical", margin: {
        left: 20
      }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { type: "number", hide: true }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { type: "category", dataKey: "name", axisLine: false, tickLine: false, tick: {
          fontSize: 12,
          fill: "var(--muted-foreground)"
        } }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "count", fill: "var(--primary)", radius: [0, 4, 4, 0], barSize: 22 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { contentStyle: {
          background: "var(--card)",
          border: "1px solid var(--border)",
          borderRadius: 6,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "Registration Trend (12 weeks)", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(LineChart, { data: spark.map((v, i) => ({
        w: "W" + (i + 1),
        v
      })), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "w", axisLine: false, tickLine: false, tick: {
          fontSize: 10,
          fill: "var(--muted-foreground)"
        } }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { hide: true }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Line, { type: "monotone", dataKey: "v", stroke: "var(--primary)", strokeWidth: 2, dot: false }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { contentStyle: {
          background: "var(--card)",
          border: "1px solid var(--border)",
          borderRadius: 6,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-5 mb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "Venue Utilisation", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: venueData.map((v) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm mb-1.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-xs text-muted-foreground tabular", children: [
            v.events,
            " events"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 bg-muted rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full bg-primary", style: {
          width: v.events / 3 * 100 + "%"
        } }) })
      ] }, v.name)) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "Top Programmes", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { className: "divide-y divide-border", children: [...EVENTS].sort((a2, b) => b.registered - a2.registered).slice(0, 5).map((e, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-4 py-2.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-xl font-semibold tabular w-6 text-primary", children: String(i + 1).padStart(2, "0") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 text-sm font-medium truncate", children: e.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-xs text-muted-foreground tabular", children: [
          e.registered,
          " reg."
        ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "Recent Activity", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "divide-y divide-border", children: REGISTRATIONS.slice().reverse().map((r2) => {
      const u = USERS.find((x2) => x2.id === r2.userId);
      const e = eventById(r2.eventId);
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-4 py-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-2 w-2 rounded-full bg-primary shrink-0" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Pill, { tone: r2.paymentStatus === "paid" ? "sage" : "rose", children: r2.paymentStatus }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-muted-foreground tabular w-24 text-right", children: fmtDate(r2.registeredAt) })
      ] }, r2.id);
    }) }) })
  ] });
}
function ParticipantDash({
  ...
  const myRegs = REGISTRATIONS.filter((r2) => r2.userId === userId);
  const myEvents = myRegs.map((r2) => ({
    reg: r2,
    event: eventById(r2.eventId)
  })).filter((x2) => x2.event);
  const upcoming = myEvents.filter((x2) => new Date(x2.event.date) > /* @__PURE__ */ new Date()).sort((a2, b) => +new Date(a2.event.date) - +new Date(b.event.date));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Page, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Eyebrow, { children: [
        "Participant · ",
        roll ?? "—"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-5xl font-semibold mt-3", children: [
        "Hi, ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("em", { className: "italic", children: name.split(" ")[0] }),
        "."
      ] })
    ] }),
    next && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card p-7 mb-8 shadow-warm relative overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-0 right-0 h-full w-1 bg-primary" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Eyebrow, { children: "Up next" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-semibold mt-3", children: next.event.name }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-mono text-[11px] uppercase tracking-wider text-muted-foreground mt-2 tabular", children: [
        fmtDate(next.event.date),
        " · ",
        venueById(next.event.venueId)?.name
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 flex flex-wrap items-center gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-3xl font-semibold tabular", children: (() => {
          const c2 = countdown(next.event.date);
          return `${c2.d}d · ${c2.h}h · ${c2.m}m`;
        })() }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/events/$eventId", params: {
          eventId: next.event.id
        }, className: "text-sm text-primary hover:underline", children: "View programme →" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 pt-5 border-t border-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[10px] uppercase tracking-wider text-muted-foreground mb-2", children: "Prep checklist" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "text-sm space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", defaultChecked: true, className: "accent-primary" }),
            " Read rules"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Registered", value: myRegs.length.toString().padStart(2, "0") }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Upcoming", value: upcoming.length.toString().padStart(2, "0"), accent: "ember" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Awaiting Payment", value: myRegs.filter((r2) => r2.paymentStatus === "pending").length.toString().padStart(2, "0"), accent: "rose" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Completed", value: "00", accent: "sage" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "Your Journey", className: "mb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ol", { className: "grid grid-cols-5 gap-2 relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-3 left-[10%] right-[10%] h-px bg-border" }),
      ["Registered", "Paid", "Upcoming", "Completed", "Results"].map((s2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "text-center relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `mx-auto h-6 w-6 rounded-full grid place-items-center font-mono text-[10px] tabular relative z-10 ${i < 3 ? "bg-primary text-primary-foreground" : "bg-card border border-border text-muted-foreground"}`, children: i + 1 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-sm mt-3", children: s2 })
      ] }, s2))
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-5 mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "My Programme", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "divide-y divide-border", children: [
        myEvents.map(({
          reg,
          event
        }) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/events/$eventId", params: {
          eventId: event.id
        }, className: "block group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-medium group-hover:text-primary", children: event.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Pill, { tone: reg.paymentStatus === "paid" ? "sage" : "rose", children: reg.paymentStatus })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-mono text-[11px] text-muted-foreground tabular mt-1", children: [
            fmtDate(event.date),
            " · ",
            venueById(event.venueId)?.name
          ] })
        ] }) }, reg.id)),
        myEvents.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display italic text-muted-foreground py-6 text-center", children: "No events yet. The story begins soon." })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "Payment Ledger", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "text-left font-mono text-[10px] uppercase tracking-wider text-muted-foreground border-b border-border", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: myRegs.map((r2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border last:border-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 font-mono text-xs tabular text-muted-foreground", children: fmtDate(r2.registeredAt) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: "Registration" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "text-right font-mono tabular", children: fmtPKR(r2.amount) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Pill, { tone: r2.paymentStatus === "paid" ? "sage" : "rose", children: r2.paymentStatus }) })
        ] }, r2.id)) })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "Accommodation", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-3 gap-4", children: ROOM_TYPES.map((rt) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-border p-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-lg font-medium", children: rt.name }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display text-2xl font-semibold tabular mt-4", children: [
        fmtPKR(rt.price),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground font-sans font-normal", children: "/night" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "mt-4 w-full text-sm border border-border rounded-md py-2 hover:border-primary/40 hover:text-primary transition-colors", children: "Book room" })
    ] }, rt.id)) }) })
  ] });
}
function OrganizerDash() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Page, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-5xl font-semibold mt-3", children: [
        "Editor's ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("em", { className: "italic", children: "Desk" }),
        "."
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-4 gap-4 mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "My Events", value: "08" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Total Reg.", value: "487", accent: "ember" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Upcoming Rounds", value: "14" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Avg Fill Rate", value: "78%", accent: "sage" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "My Events", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "text-left font-mono text-[10px] uppercase tracking-wider text-muted-foreground border-b border-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "py-2", children: "Programme" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Category" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Date" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right", children: "Reg." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right", children: "Status" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: EVENTS.map((e) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border last:border-0 hover:bg-muted/30", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 font-medium", children: e.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Pill, { tone: "muted", children: e.category }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "font-mono text-xs tabular text-muted-foreground", children: fmtDate(e.date) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "text-right font-mono tabular", children: [
          e.registered,
          "/",
          e.capacity
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Pill, { tone: e.status === "filling" ? "ember" : e.status === "closed" ? "rose" : "sage", children: e.status }) })
      ] }, e.id)) })
    ] }) })
  ] });
}
function JudgeDash() {
  const board = LEADERBOARDS.e1;
  const [scores, setScores] = reactExports.useState(board);
  reactExports.useEffect(() => {
    const id = setInterval(() => {
      setScores((prev) => [...prev].map((r2) => ({
        ...r2,
        score: Math.min(10, r2.score + (Math.random() - 0.5) * 0.3)
      })).sort((a2, b) => b.score - a2.score).map((r2, i) => ({
        ...r2,
        rank: i + 1
      })));
    }, 4e3);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Page, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Eyebrow, { children: "Today's adjudications" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-5xl font-semibold mt-3", children: [
        "Adjudication ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("em", { className: "italic", children: "Desk" }),
        "."
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-3 gap-4 mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Assigned", value: "03", accent: "ember" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Submitted", value: "14", accent: "sage" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Pending", value: "22", accent: "rose" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-5 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "Score: Speed Programming · Hassan T.", className: "lg:col-span-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "font-mono text-[10px] uppercase tracking-wider text-muted-foreground", children: "Score (0–10)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "range", min: "0", max: "10", step: "0.1", defaultValue: "8.5", className: "mt-3 w-full accent-primary" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-3xl font-semibold tabular text-primary mt-2", children: "8.50" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "font-mono text-[10px] uppercase tracking-wider text-muted-foreground", children: "Comments" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { rows: 4, placeholder: "share your evaluation…", className: "mt-2 w-full bg-transparent border-b border-border focus:border-primary outline-none py-2 font-display italic placeholder:font-display placeholder:italic placeholder:text-muted-foreground/60 text-sm" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "bg-primary text-primary-foreground px-5 py-2.5 rounded-md text-sm font-medium hover:bg-primary-dark transition-colors", children: "Submit evaluation" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "Live Leaderboard", className: "lg:col-span-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { className: "divide-y divide-border", children: scores.slice(0, 5).map((r2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-3 py-2.5 transition-all duration-500", style: {
        animation: "glow 1.2s ease-out"
      }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-xl font-semibold tabular w-7 text-primary", children: String(r2.rank).padStart(2, "0") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium flex-1 truncate", children: r2.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-sm tabular text-foreground", children: r2.score.toFixed(2) })
      ] }, r2.name)) }) })
    ] })
  ] });
}
function SponsorDash({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Page, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-5xl font-semibold mt-3", children: name })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border-2 border-primary/30 bg-card p-10 mb-8 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[10px] uppercase tracking-[0.2em] text-muted-foreground", children: "Patron Certificate · Edition XXVI" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-6xl font-semibold mt-5 text-primary", children: tier }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-xl tabular text-foreground mt-4", children: fmtPKR(25e5) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Hairline, { className: "mx-auto max-w-xs my-6" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "text-sm text-muted-foreground space-y-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "· Logo on all marketing materials" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "· Stage time at opening ceremony" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "· Booth at sponsor pavilion" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "· First-pick of recruitment talent" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-3 gap-4 mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Brand Impressions", value: "48,200", accent: "ember" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Event Reach", value: "08" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Participants Engaged", value: "312", accent: "sage" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "Sponsored Programmes", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 gap-4", children: EVENTS.slice(0, 3).map((e) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/events/$eventId", params: {
      eventId: e.id
    }, className: "rounded-lg border border-border p-5 hover:border-primary/40 transition-colors block", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Eyebrow, { children: e.category }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-medium mt-2", children: e.name }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-mono text-[11px] text-muted-foreground mt-2 tabular", children: [
        e.registered,
        " participants reached"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CapacityBar, { filled: e.registered, total: e.capacity }) })
    ] }, e.id)) }) })
  ] });
}
function Panel({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: `rounded-lg border border-border bg-card p-5 ${className ?? ""}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-semibold", children: title }) }),
    children
  ] });
}
export {
