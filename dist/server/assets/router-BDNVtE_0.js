...
import { W as WriteStream, R as ReadStream } from "./worker-entry-so00yvqm.js";
  ...
  */
  constructor(options, getStoreConfig) {
    ...
    this.clearCache = (opts) => {
      ...
      if (filter2 !== void 0) this.stores.setCached(this.stores.cachedMatches.get().filter((m2) => !filter2(m2)));
...
const AUTH_TOKEN_KEY = "softec.auth.token";
...
function AuthProvider({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Ctx$1.Provider, { value: { user, loading, login, signup, logout }, children });
}
function useAuth() {
...
function ThemeProvider({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Ctx.Provider, { value: { theme, setTheme: chooseTheme, toggle: () => chooseTheme(theme === "light" ? "dark" : "light") }, children });
}
...
var Presence = (props) => {
  ...
  const ref2 = useComposedRefs(presence.ref, getElementRef$1(child));
...
const BedDouble = createLucideIcon("bed-double", __iconNode$8);
const __iconNode$7 = [
...
const CmdCtx = reactExports.createContext(null);
function CommandPaletteProvider({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CmdCtx.Provider, { value: { isOpen, open: () => setOpen(true), close: () => setOpen(false) }, children: [
    children,
    isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-start justify-center pt-[12vh] px-4 bg-ink/40 backdrop-blur-sm animate-fade-in", onClick: () => setOpen(false), children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { onClick: (e) => e.stopPropagation(), className: "w-full max-w-xl rounded-xl border border-border bg-card shadow-warm-lg overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(_e, { className: "bg-card", loop: true, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(_e.List, { className: "max-h-[60vh] overflow-y-auto p-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(_e.Empty, { className: "px-4 py-6 text-sm text-muted-foreground italic font-display", children: "No results. The story continues elsewhere." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(_e.Group, { heading: "Navigate", className: "[&_[cmdk-group-heading]]:font-display [&_[cmdk-group-heading]]:text-xs [&_[cmdk-group-heading]]:text-muted-foreground [&_[cmdk-group-heading]]:px-3 [&_[cmdk-group-heading]]:pt-2 [&_[cmdk-group-heading]]:pb-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CmdItem, { icon: LayoutDashboard, label: "Dashboard", hint: "g d", onSelect: () => go("/app/dashboard") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CmdItem, { icon: Calendar, label: "Browse Programmes", hint: "g e", onSelect: () => go("/app/events") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CmdItem, { icon: Users, label: "Members", onSelect: () => go("/app/users") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CmdItem, { icon: FileText, label: "Reports", onSelect: () => go("/app/reports") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CmdItem, { icon: BedDouble, label: "Accommodation", onSelect: () => go("/app/accommodation") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CmdItem, { icon: Trophy, label: "Leaderboards", onSelect: () => go("/app/leaderboards") })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(_e.Group, { heading: "Actions", className: "[&_[cmdk-group-heading]]:font-display [&_[cmdk-group-heading]]:text-xs [&_[cmdk-group-heading]]:text-muted-foreground [&_[cmdk-group-heading]]:px-3 [&_[cmdk-group-heading]]:pt-3 [&_[cmdk-group-heading]]:pb-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CmdItem, { icon: Sparkles, label: "Create new programme", hint: "c", onSelect: () => go("/app/events/new") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CmdItem, { icon: Sun, label: "Toggle theme", onSelect: () => {
            toggle();
            setOpen(false);
          } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CmdItem, { icon: LogOut, label: "Sign out", onSelect: () => {
            logout();
            setOpen(false);
            navigate({ to: "/" });
          } })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(_e.Group, { heading: "Programmes", className: "[&_[cmdk-group-heading]]:font-display [&_[cmdk-group-heading]]:text-xs [&_[cmdk-group-heading]]:text-muted-foreground [&_[cmdk-group-heading]]:px-3 [&_[cmdk-group-heading]]:pt-3 [&_[cmdk-group-heading]]:pb-1", children: events.slice(0, 6).map((e) => /* @__PURE__ */ jsxRuntimeExports.jsx(CmdItem, { icon: Calendar, label: e.name, hint: e.category, onSelect: () => go(`/events/${e.id}`) }, e.id)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border px-3 py-2 flex items-center justify-between text-[10px] font-mono uppercase tracking-wider text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "SOFTEC Command" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "↑↓ navigate · ↵ select · esc close" })
      ] })
    ] }) }) })
  ] });
}
function CmdItem({ icon: Icon2, label, hint, onSelect }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(_e.Item, { onSelect, className: "flex items-center gap-3 px-3 py-2 rounded-md text-sm cursor-pointer aria-selected:bg-muted aria-selected:text-foreground text-foreground/85", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "h-4 w-4 text-muted-foreground", strokeWidth: 1.75 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1", children: label }),
    hint && /* @__PURE__ */ jsxRuntimeExports.jsx("kbd", { className: "font-mono text-[10px] px-1.5 py-0.5 rounded bg-muted text-muted-foreground border border-border", children: hint })
  ] });
}
function useCommandPalette() {
  const c = reactExports.useContext(CmdCtx);
  if (!c) return { open: () => {
  }, close: () => {
  }, isOpen: false };
  return c;
}
const appCss = "/assets/styles-DnGOqgeg.css";
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "eyebrow", children: "Error · 404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-7xl font-semibold mt-4 text-foreground", children: [
      "Lost in the ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("em", { className: "italic", children: "programme" }),
      "."
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm text-muted-foreground", children: "The page you're looking for has wandered off. Let's get you home." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "mt-6 inline-flex items-center justify-center rounded-md bg-primary px-5 py-2.5 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary-dark", children: "Return home" })
  ] }) });
}
function ErrorComponent({ error, reset }) {
  ...
  const router2 = useRouter();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "eyebrow", children: "Something broke" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-3xl font-semibold mt-3 text-foreground", children: "A small editorial mishap." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex flex-wrap justify-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/", className: "rounded-md border border-border bg-card px-4 py-2 text-sm font-medium hover:border-primary/40", children: "Home" })
    ] })
  ] }) });
}
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AuthProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CommandPaletteProvider, { children: [
...
const $$splitComponentImporter$g = () => import("./signup-C1Dd_ugN.js");
const Route$h = createFileRoute("/signup")({
  head: () => ({
    meta: [{
      title: "Register — SOFTEC '26"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$g, "component")
});
const $$splitComponentImporter$f = () => import("./login-DNC9TVVh.js");
const Route$g = createFileRoute("/login")({
  head: () => ({
    meta: [{
      title: "Sign in — SOFTEC '26"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$f, "component")
});
const $$splitComponentImporter$e = () => import("./events-a6mwYrvn.js");
const Route$f = createFileRoute("/events")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "All competitions and events at SOFTEC '26."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import("./app-_l8ndbPh.js");
...
const $$splitComponentImporter$c = () => import("./index-CAFNBNpO.js");
const Route$d = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "The flagship technology festival of FAST-NUCES. March 2026, Lahore."
    }]
  }),
...
const $$splitNotFoundComponentImporter = () => import("./events._eventId-DYEpEt7E.js");
const $$splitComponentImporter$b = () => import("./events._eventId-CS27Fkvx.js");
const Route$b = createFileRoute("/events/$eventId")({
  head: () => ({
    meta: [{
      title: "Programme Detail — SOFTEC '26"
    }, {
      name: "description",
      content: "SOFTEC programme details and leaderboard."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$b, "component"),
  notFoundComponent: lazyRouteComponent($$splitNotFoundComponentImporter, "notFoundComponent")
});
const $$splitComponentImporter$a = () => import("./app.users-D1ZJYdQ0.js");
const Route$a = createFileRoute("/app/users")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./app.teams-QsTWN_0V.js");
const Route$9 = createFileRoute("/app/teams")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./app.sponsorship-D4VKU-dF.js");
const Route$8 = createFileRoute("/app/sponsorship")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./app.sponsors-FZY26eDX.js");
const Route$7 = createFileRoute("/app/sponsors")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./app.reports-BjmVZ9eY.js");
const Route$6 = createFileRoute("/app/reports")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./app.leaderboards-DCdxbkdc.js");
const Route$5 = createFileRoute("/app/leaderboards")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./app.judging-BMrujcll.js");
const Route$4 = createFileRoute("/app/judging")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./app.events-BXyU1Klf.js");
const Route$3 = createFileRoute("/app/events")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./app.dashboard-BASJPx4Y.js");
const Route$2 = createFileRoute("/app/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./app.accommodation-BKWoB25x.js");
const Route$1 = createFileRoute("/app/accommodation")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./app.events.new-79oKOjVI.js");
const Route2 = createFileRoute("/app/events/new")({
...
const EventsEventIdRoute = Route$b.update({
  id: "/$eventId",
  path: "/$eventId",
...
const AppTeamsRoute = Route$9.update({
  id: "/teams",
  path: "/teams",
  getParentRoute: () => AppRoute
});
const AppSponsorshipRoute = Route$8.update({
  id: "/sponsorship",
  path: "/sponsorship",
  getParentRoute: () => AppRoute
});
const AppSponsorsRoute = Route$7.update({
  id: "/sponsors",
  path: "/sponsors",
  getParentRoute: () => AppRoute
});
...
const AppLeaderboardsRoute = Route$5.update({
  id: "/leaderboards",
  path: "/leaderboards",
  getParentRoute: () => AppRoute
});
const AppJudgingRoute = Route$4.update({
  id: "/judging",
  path: "/judging",
  getParentRoute: () => AppRoute
});
const AppEventsRoute = Route$3.update({
  id: "/events",
  path: "/events",
  getParentRoute: () => AppRoute
});
...
const AppAccommodationRoute = Route$1.update({
  id: "/accommodation",
  path: "/accommodation",
  getParentRoute: () => AppRoute
});
const AppEventsNewRoute = Route2.update({
  id: "/new",
  path: "/new",
  getParentRoute: () => AppEventsRoute
});
const AppEventsRouteChildren = {
  AppEventsNewRoute
};
